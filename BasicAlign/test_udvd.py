...
for test_loader in test_loaders:
    ...
    for data in test_loader:
        ...
        if suffix:
            ...
            save_img_out_path = osp.join(dataset_dir, img_name + '_out.jpg')
            save_img_in_path = osp.join(dataset_dir, img_name + '_in.jpg')
            save_img_ori_path = osp.join(dataset_dir, img_name + '_ori.jpg')
        if opt['save_img']:
