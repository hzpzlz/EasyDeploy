...
class DenoiseModel(BaseModel):
    def __init__(self, opt):
        super(DenoiseModel, self).__init__(opt)
    ...
    def optimize_parameters(self):
        ...
        self.output, _ = self.netG(self.noise_inputs)
        ...
        loss = self.l_pix_w * self.cri_pix(self.output, clean_gt)
    ...
    def get_current_visuals(self):
        ...
        out_dict['output_stn'] = self.output_stn
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            self.output, self.output_stn = self.netG(self.noise_inputs)
