...
class Unet(nn.Module):
    ...
    def forward(self, x):
        ...
        #up6 = self.up_stn6(conv5, conv4.shape[-2:])
        ...
        #up7 = self.up_stn7(conv6, conv3.shape[-2:])
        ...
        #up8 = self.up_stn8(conv7, conv2.shape[-2:])
        ...
        #up9 = self.up_stn9(conv8, conv1.shape[-2:])
...
class STN_Unet_v1(nn.Module):
    def __init__(self, cpf=3, n_frame=5, out_nc=3):
        super(STN_Unet_v1, self).__init__()
        self.unet1 = Unet()
        self.unet2 = Unet()
        self.unet4 = Unet()
        self.unet5 = Unet()
