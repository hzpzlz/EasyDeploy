...
class Unet(nn.Module):
    def __init__(self, in_channels=4, out_channels=4):
        ...
        self.conv1_1 = nn.Conv2d(in_channels, 32, kernel_size=3, stride=1, padding=1, bias=True)
        ...
        self.conv10_1 = nn.Conv2d(32, out_channels, kernel_size=1, stride=1, bias=True)
