...
class FlowEstimatorDense(nn.Module):
    def __init__(self, ch_in, batch_norm=False):
        ...
        self.conv1 = conv(batch_norm, ch_in, 128)
        self.conv2 = conv(batch_norm, ch_in+128, 128)
        self.conv3 = conv(batch_norm, ch_in+128+128, 96)
        self.conv4 = conv(batch_norm, ch_in+128+128+96, 64)
        self.conv5 = conv(batch_norm, ch_in+128+128+96+64, 32)
        self.conv_last = nn.Conv2d(in_channels = ch_in+448, out_channels = 2, kernel_size = 3, stride = 1, padding = 1, dilation = 1, groups = 1, bias = True)
