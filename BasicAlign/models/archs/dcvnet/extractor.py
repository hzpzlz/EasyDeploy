...
class BasicEncoder(nn.Module):
    def __init__(self, output_dim=128, norm_fn='instance', dropout=0.0):
        ...
        self.conv_s2 = nn.Conv2d(64, 128, 3, 1, 1)
        self.layer2 = self._make_layer(128, stride=2)
        self.layer3 = self._make_layer(192, stride=2)

        # output convolution
        self.conv2 = nn.Conv2d(192, output_dim, 3, 1, 1)
    ...
    def forward(self, x):
        ...
        if is_list:
            ...
            y = torch.split(y, [batch_dim, batch_dim], dim=0)
...
class SmallEncoder(nn.Module):
    def __init__(self, output_dim=128, norm_fn='instance', dropout=0.0):
        ...
        self.conv_s2 = nn.Conv2d(32, 64, 3, 1, 1)
