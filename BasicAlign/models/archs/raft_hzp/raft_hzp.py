...
from .update_hzp import BasicUpdateBlock, SmallUpdateBlock
from .extractor_hzp import BasicEncoder, SmallEncoder
from .corr_hzp import CorrBlock, AlternateCorrBlock
from .utils_hzp import bilinear_sampler, coords_grid, upflow8
...
class RAFT(nn.Module):
    def __init__(self, opt):
        ...
        self.test_mode = False if opt['is_train'] == True else True
    ...
    def forward(self, image1, image2, flow_init=None, upsample=True, test_mode=None):
        ...
        with autocast(enabled=self.mixed_precision):
            ...
            # F(t+1) = F(t) + \Delta(t)
        coords1 = coords1 + delta_flow  #论文中 0->那一列 更新
